...
function saveToCalendar() {
  const title = "Pernikahan Sonya & David ";
  const start = "20250804T000000Z"; // 14 Nov 2025, 07:00 WIB
  const end   = "20250804T050000Z"; // 14 Nov 2025, 12:00 WIB
  const details = "Undangan pernikahan Sonya & David ";
  const location = "https://maps.app.goo.gl/a8zaVu7fZiHHrvst9"; // link Google Maps
